                                ...
                                <div className="hcontact-info">
                                    <ul>
                                        <li className="wow fadeInDown" data-wow-delay="0.1s"><a
                                            href="tel:+2123456789"><i
                                            className="fas fa-phone-alt"></i>+21 23456789</a></li>
                                        <li className="wow fadeInDown" data-wow-delay="0.2s"><a
                                            href="mailto:store@domain.com"><i className="far fa-envelope"></i>store@domain.com</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div className="container-lg">
                        <div className="hmiddle-inner">
                            ...
                            <div className="middle-colmn">
                                {/* <div className="logo"><a href="index.html"><img src="/images/store-logo.png"
                                                                                alt="store.com"
                            ...
                            <div className="right-colmn">
                                <div className="hcontent_icons">
                                    <ul>
                                        <li className="wow fadeInUp" data-wow-delay="0.1s"><a id="hsearch" href="#"><i
                                            className="fas fa-search"></i></a></li>
                                        <li className="h-account wow fadeInUp" data-wow-delay="0.2s"><a href="#"><i
                                            className="far fa-user-circle"></i></a>
                                        ...
                                        <li className="wow fadeInUp" data-wow-delay="0.3s"><a href="#"><i
                                ...
                                <div className="hamburger-menu wow fadeInUp" data-wow-delay="0.5s"><a href="#my-menu"><i
                                    className="fas fa-bars"></i> <i className="fas fa-times"></i></a></div>
                            </div>
                        </div>
                    </div>
